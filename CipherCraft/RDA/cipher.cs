...
/// <summary>
/// RDA512-bit (encryption) ALGORITHM
/// Founded by Alex Weight; November ‎12, ‎2017
/// Developed by: Alex Weight, Solomon Victorino, and Jesse Hoffman.
/// Desc: Secure files and data using 512 bit hashes through modern, dynamic algorithms.
/// 
/// WE STRONGLY ASK FOR THIS SOURCE TO BE USED RESPONSIBLY.
/// Permissions are granted of use to function(s) provided with respect to crediting the owner at your own will.
/// </summary>

namespace RDA_Encryption_Algorithms
{
    ...
    class Algorithm
    {
        ...
        private string df(decimal a, decimal b)
        {
            ...
            ulong c = (ulong)(Math.Abs(a)) ^ (ulong)Math.Abs(b);
